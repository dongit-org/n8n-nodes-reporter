...
export class ReporterPollingTrigger implements INodeType {
        ...
        properties: [
            {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when a new assessment is created",
                    },
                    {
                        name: "Updated Assessment",
                        value: "assessment_updated",
                        description:
                            "Triggers when an existing assessment is updated",
                    },
                    {
                        name: "New Assessment Template",
                        value: "assessmentTemplate_created",
                        description:
                            "Triggers when a new assessment template is created",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when an existing custom field is updated",
                    },
                    {
                        name: "New Finding",
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when an existing finding is updated",
                    },
                    {
                        name: "New Finding Layout",
                        value: "findingLayout_created",
                        description:
                            "Triggers when a new finding layout is created",
                    },
                    {
                        name: "Updated Finding Layout",
                        value: "findingLayout_updated",
                        description:
                            "Triggers when an existing finding layout is updated",
                    },
                    {
                        name: "New Finding Event",
                        value: "findingEvent_created",
                        description:
                            "Triggers when a new finding event is created",
                    },
                    {
                        name: "Updated Finding Event",
                        value: "findingEvent_updated",
                        description:
                            "Triggers when an existing finding event is updated",
                    },
                    {
                        name: "New Finding Template",
                        value: "findingTemplate_created",
                        description:
                            "Triggers when a new finding template is created",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when an existing language is updated",
                    },
                    {
                        name: "New Output File",
                        value: "outputFile_created",
                        description:
                            "Triggers when a new output file is created",
                    },
                    {
                        name: "Updated Output File",
                        value: "outputFile_updated",
                        description:
                            "Triggers when an existing output file is updated",
                    },
                    {
                        name: "New Tool Finding",
                        value: "toolFinding_created",
                        description:
                            "Triggers when a new tool finding is created",
                    },
                    {
                        name: "Updated Tool Finding",
                        value: "toolFinding_updated",
                        description:
                            "Triggers when an existing tool finding is updated",
                    },
                    {
                        name: "New Tool Target",
                        value: "toolTarget_created",
                        description:
                            "Triggers when a new tool target is created",
                    },
                    {
                        name: "Updated Tool Target",
                        value: "toolTarget_updated",
                        description:
                            "Triggers when an existing tool target is updated",
                    },
                    {
                        name: "New Role",
                        value: "role_created",
                    ...
                    },
                    {
                        ...
                        value: "role_updated",
                        description:
                            "Triggers when an existing role is updated",
                    },
                    {
                        name: "New Target",
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when an existing target is updated",
                    },
                    {
                        name: "New Task",
                        value: "task_created",
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when an existing task set is updated",
                    },
                    {
                        name: "New Theme",
                        value: "theme_created",
                    ...
                    },
                    {
                        ...
                        value: "theme_updated",
                        description:
                            "Triggers when an existing theme is updated",
                    },
                    {
                        name: "New User",
                        value: "user_created",
                    ...
                    },
                    {
                        ...
                        description:
                            "Triggers when a new user group is created",
                    },
                    {
                        name: "Updated User Group",
                        value: "userGroup_updated",
                        description:
                            "Triggers when an existing user group is updated",
                    },
                ],
    ...
    async poll(this: IPollFunctions): Promise<INodeExecutionData[][] | null> {
        ...
        const sortParam = this.getNodeParameter("sort", 0) as string;
        if (sortParam) {
